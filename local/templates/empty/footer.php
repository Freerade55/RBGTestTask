...
<script src="<?=SITE_TEMPLATE_PATH?>/assets/js/jquery-migrate-3.0.0.js"></script>
...
<script src="<?=SITE_TEMPLATE_PATH?>/assets/js/jquery.waypoints.min.js"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/assets/js/jquery.stellar.min.js"></script>
